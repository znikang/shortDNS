<?php /*a:2:{s:49:"/www/wwwroot/dwz.com/app/admin/view/dwz/form.html";i:1623497815;s:52:"/www/wwwroot/dwz.com/app/admin/view/common/base.html";i:1623501236;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
<form class="form-horizontal" action="<?php echo url('index',['act' => 'addurl']); ?>" method="post">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="text" name="remarks"  placeholder="例如：0612未使用" id="remarks" class="col-xs-10 col-sm-5" value="<?php echo isset($banner['remarks']) ? htmlentities($banner['remarks']) : ''; ?>" required="required">
...
<div class="space-4"></div>
<div class="form-group">
    <label class="col-sm-1 control-label no-padding-right" for="urls"> 域名 </label>
    <div class="col-sm-9">
        <textarea class="ace_text-input col-xs-10 col-sm-5" id="urls" name="urls" placeholder="输入格式如：&#13;&#10;a001.com&#13;&#10;a001.com&#13;&#10;每个域名换一行" data-val="true" style="height: 200px" data-val-required="请输入正确的链接"></textarea>
        <span class="help-inline col-xs-12 col-sm-7">
            <span class="middle"></span>
        </span>
    </div>
