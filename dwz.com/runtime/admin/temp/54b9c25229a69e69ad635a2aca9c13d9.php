<?php /*a:2:{s:49:"/www/wwwroot/dwz.com/app/admin/view/dwz/edit.html";i:1623740606;s:52:"/www/wwwroot/dwz.com/app/admin/view/common/base.html";i:1623501236;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
<form class="form-horizontal" action="<?php echo url('index',['act' => 'save']); ?>" method="post">
<input type="hidden" name="id" value="<?php echo isset($dwz['id']) ? htmlentities($dwz['id']) : 0; ?>">
<div class="space-4"></div>
<div class="form-group">
    <label class="col-sm-1 control-label no-padding-right" for="remarks"> 备注 </label>
    <div class="col-sm-9">
        <input type="text" name="remarks"  placeholder="例如：0612未使用" id="remarks" class="col-xs-10 col-sm-5" value="<?php echo isset($dwz['remarks']) ? htmlentities($dwz['remarks']) : ''; ?>" required="required">
...
<div class="space-4"></div>
<div class="form-group">
    <label class="col-sm-1 control-label no-padding-right" for="domain"> 短域名 </label>
    <div class="col-sm-9">
        <input readonly type="text" name="domain"  id="domain" class="col-xs-10 col-sm-5" value="<?php echo isset($dwz['domain']) ? htmlentities($dwz['domain']) : ''; ?>" required="required">
        <span class="help-inline col-xs-12 col-sm-7">
            <span class="middle"></span>
        </span>
    </div>
...
<div class="space-4"></div>
<div class="form-group">
    <label class="col-sm-1 control-label no-padding-right" for="url"> 长链接 </label>
    <div class="col-sm-9">
        <input type="text" name="url"  placeholder="例如：https://baidu.com?code=xxxx" id="url" class="col-xs-10 col-sm-5" value="<?php echo isset($dwz['url']) ? htmlentities($dwz['url']) : ''; ?>" required="required">
        <span class="help-inline col-xs-12 col-sm-7">
            <span class="middle"></span>
        </span>
    </div>
...
<div class="space-4"></div>
<div class="form-group">
    <label class="col-sm-1 control-label no-padding-right" for="tj_code"> 51统计ID </label>
    <div class="col-sm-9">
        <input type="text" name="tj_code"  placeholder="例如：JLPUCLKCueiLh6I2" id="tj_code" class="col-xs-10 col-sm-5" value="<?php echo isset($dwz['tj_code']) ? htmlentities($dwz['tj_code']) : ''; ?>" >
        <span class="help-inline col-xs-12 col-sm-7">
            <span class="middle"></span>
        </span>
    </div>
...
<div class="space-4"></div>
<div class="form-group">
    <label class="col-sm-1 control-label no-padding-right" for="type"> 防红模式 </label>
    <div class="control-label col-sm-1">
        <label>
            <input name="type" id="type" <?php if(!(empty($dwz) || (($dwz instanceof \think\Collection || $dwz instanceof \think\Paginator ) && $dwz->isEmpty()))): if($dwz['type'] == 1): ?>checked="checked"<?php endif; else: ?>checked="checked"<?php endif; ?> value="1" class="ace ace-switch ace-switch-2" type="checkbox" />
            <span class="lbl"></span>
        </label>
