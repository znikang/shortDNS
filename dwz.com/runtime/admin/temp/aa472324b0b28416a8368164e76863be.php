<?php /*a:2:{s:54:"/www/wwwroot/dwz.com/app/admin/view/godaddy/index.html";i:1625886913;s:52:"/www/wwwroot/dwz.com/app/admin/view/common/base.html";i:1623501236;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    <div class="row">
        <div class="widget-body">
            ...
            $('#content').html(data);
                ...
                <section>
                    <a class="btn btn-info" href="<?php echo url('index',['act'=>'add']); ?>" value="">添加解析</a>
                    &nbsp; &nbsp; &nbsp; &nbsp; 
                    <label>
                    <!--     状态：
                    </label>
    ...
    <form id="form" method="post" action="<?php echo url('index',['act'=>'del']); ?>">
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
            <tr <?php if($val['status'] == 2): ?>style="color:red"<?php endif; ?>>
                ...
                <td class="center"><?php echo htmlentities($val['host_record']); ?></td>
                <td class="center"><?php echo htmlentities($val['ip']); ?></td>
                <td class="center"><?php echo htmlentities($val['addtime']); ?></td>

                <td class="center"><?php if($val['status'] == 1): ?><span style="color: green">正常
                </span>
                <?php else: ?><span style="color: red">出错</span>
                <?php endif; ?>  
                    
                </td>
                <td class="center hidden-sm hidden-xs"><?php echo htmlentities((isset($val['err_msg']) && ($val['err_msg'] !== '')?$val['err_msg']:'无')); ?></td>
